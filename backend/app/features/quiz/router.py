...
from app.features.quiz.service import generate_quiz
...
async def generate_interactive_quiz(request: QuizRequest):
    ...
    3. How it works:
       - The backend sends the document to the model and extracts 3-5 critical multiple-choice questions.
    ...
    result = await generate_quiz(
        document_context=request.document_context, language_code=request.language_code
    )
    return result
