...
from app.features.tts.schemas import TTSRequest, TTSResponse
from app.features.tts.service import generate_speech
...
async def text_to_speech(request: TTSRequest):
    """
    Generate Text-to-Speech audio from text using the OpenAI audio API.
    ...
    3. Payload Size: OpenAI TTS handles short text snippets, making the file sizes manageable over JSON.
