...
class ChatRequest(BaseModel):
    document_context: str = Field(..., description="The parsed terms/policy text from the frontend.")
    question: str = Field(..., description="The user's latest question.")
    history: List[ChatMessage] = Field(default_factory=list, description="Array of previous messages to maintain chat history.")
