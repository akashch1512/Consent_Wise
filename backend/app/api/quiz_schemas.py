...
class QuizQuestion(BaseModel):
    question: str = Field(..., description="The multiple-choice question focusing on critical risks or penalties")
    ...
    explanation: str = Field(..., description="A clear, short explanation for why this is the correct answer")
